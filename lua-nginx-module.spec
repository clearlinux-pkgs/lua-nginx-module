...
Version  : 0.10.22
Release  : 31
URL      : https://github.com/openresty/lua-nginx-module/archive/v0.10.22/lua-nginx-module-0.10.22.tar.gz
Source0  : https://github.com/openresty/lua-nginx-module/archive/v0.10.22/lua-nginx-module-0.10.22.tar.gz
...
%prep
%setup -q -n lua-nginx-module-0.10.22
cd %{_builddir}/lua-nginx-module-0.10.22
%patch1 -p1
