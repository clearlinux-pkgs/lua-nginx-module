...
Version  : 0.10.17
Release  : 3
URL      : https://github.com/openresty/lua-nginx-module/archive/v0.10.17/lua-nginx-module-0.10.17.tar.gz
Source0  : https://github.com/openresty/lua-nginx-module/archive/v0.10.17/lua-nginx-module-0.10.17.tar.gz
...
%prep
%setup -q -n lua-nginx-module-0.10.17
cd %{_builddir}/lua-nginx-module-0.10.17
