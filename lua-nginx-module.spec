...
Source0  : https://github.com/openresty/lua-nginx-module/archive/v0.10.26/lua-nginx-module-0.10.26.tar.gz
...
%prep
%setup -q -n lua-nginx-module-0.10.26
cd %{_builddir}/lua-nginx-module-0.10.26
pushd ..
cp -a lua-nginx-module-0.10.26 buildavx2
popd
